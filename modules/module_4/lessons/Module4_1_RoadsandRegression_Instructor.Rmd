...
![](images/coefficient_correlation.jpg) The greater the magnitude (size) of the correlation coefficient, the stronger the relationship between the two variables. ![](images/correlation.jpg)
...
How would we interpret this `r^2` value for the ?
