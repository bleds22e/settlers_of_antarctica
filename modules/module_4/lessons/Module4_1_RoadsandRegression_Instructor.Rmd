...
We can add a line of best fit to ggplot by using the `geom_smooth()` function. We need to specify that the method we want should produce a straight line ("linear model").
