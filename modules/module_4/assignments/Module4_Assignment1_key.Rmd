...
```{r}
# Find correlation coefficient of scatterplot
...
11. Interpret the model summary. What is the p-value for our variable of interest? Do we accept or reject the null hypothesis regarding the relationship between these two variables? What can we conclude then about building a road? (2 pts)
    ...
    *Answer:* The p-value is 0.0943, so we do not reject the null hypothesis. There is a not a relationship between phosphorus content and hairgrass density, so we don't need to take it into account for our road. If they put in the wrong variables and get the incorrect model, they can still get the rest of the points as long as they interpret the one they made correctly.
