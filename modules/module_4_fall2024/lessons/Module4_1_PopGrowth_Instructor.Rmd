...
![](images/clipboard-1439389577.png){width="90" fig-align="center"}
...
![](images/clipboard-3908560513.png){width="188" fig-align="center"}
...
```{r}
library(tidyverse)
fish_pops <- read_csv("fish_pops.csv")
```
...
What type of growth is the population exhibiting? Exponential

Why is there no carrying capacity in this population data set? What does this mean about the resources Population B needs? Populations experiencing exponential growth not limited by resources.
...
Notice in this case we have carrying capacity data. Let's use a some data visualizations to help us understand what that means.
...
What are the values where each population is leveling off:
