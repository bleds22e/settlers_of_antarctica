...
First, we need to decide what type of statistical test makes sense with the data we have. This is *not* a straight-forward question with a straight-forward answer, and there are a handful of different answers. A lot of that determination ultimately depends on the question we are asking and, therefore, the hypothesis we are testing.
