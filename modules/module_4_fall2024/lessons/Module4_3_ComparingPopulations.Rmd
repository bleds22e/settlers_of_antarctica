...
3.  Combine all three data frames back together into one dataframe using the `bind_rows()` function.
...
![](residuals.jpg){width="50%" fig-align="center"}

Let's use the `mutate` function to add these model values to each data frame.
