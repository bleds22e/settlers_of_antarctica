...
5.  Write some code to choose rows that only includes temperatures which are above freezing (AKA greater than 0 because the temperature is currently in Celcius)
