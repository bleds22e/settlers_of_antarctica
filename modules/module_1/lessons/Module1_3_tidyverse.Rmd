...
![](row_column.png){fig-align="center" width="50%"}
...
1.  Slims down the full data frame to one that contains the columns with the date, average temperatures, and the city names. Assign this to an object called `slim`.
...
![](dplyr_pipe.png){fig-align="center" width="75%"}
...
-   the columns with the average temperatures, the countries, and the cities
