...
filter(climate_df, AverageTemperature > 25, Country == "United States")   # only rows that meet both conditions; could also use & instead of ,

filter(climate_df, AverageTemperature > 25 | Country == "United States" ) # rows that meet one or the other condition; the | symbol means `or`
filter(climate_df, Country == "United States" | Country == "Mexico")      # pulls rows in which the Country column has either "United States" OR "Mexico"
