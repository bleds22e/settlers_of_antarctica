...
For examples, we can use a function called `class()` to figure out the data type of a vector.
...
Come up with a definition of standard deviation, use the help file to find out how the `sd()` function works, and be prepared to show the code you used.
