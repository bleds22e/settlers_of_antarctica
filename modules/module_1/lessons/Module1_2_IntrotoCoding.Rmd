...
* Students will be able to write code that assign values to variables 
and use these variables to perform various operations.  
* Students will be able to use helpfiles to learn how to use functions.  
...
* Students will learn how to create their own data structures (vectors) and 2d 
data (dataframes).  
