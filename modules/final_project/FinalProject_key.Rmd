...
3.  What if we wanted our summary data in centimeters instead of millimeters? We can acheive this in 2 steps.
...
6.  Write the pair of statistical hypotheses for our question. (1 points)
    ...
    **Null**: no difference in the mean flipper length between male and female chinstrap penguins 
    **Alternative**: true difference in the mean flipper length between male and female chinstrap penguins
