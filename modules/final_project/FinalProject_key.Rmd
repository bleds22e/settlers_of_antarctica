...
1.  Calculate at least one measure of central tendancy and one measure of variability for the bill length for *each* island. (2 points)
...
```{r}
ggplot(dream, aes(species, flipper_length_in)) +
  geom_boxplot() +
  geom_jitter(width = 0.1, alpha = 0.5) +
  labs(x = "Species",
       y = "Flipper Length (mm)") +
...
ggplot(dream, aes(flipper_length_in, fill = species)) +
  geom_histogram(alpha = 0.5, position = "identity") +
