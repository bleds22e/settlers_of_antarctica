...
6.  Based on your own general knowledge, the information at the links above, and the additional information I've provided, list out the columns (only those in the .csv file) in your chosen dataset and give a brief description (just a phrase is fine) of what the data in each columns represents.

*Answer*:

7.  For each of the columns in your dataset, identify whether the data points they contain are qualitative (categorical) or quantitative (numeric). Be sure your answers align with the information I've provided for you above.
...
Pay close attention here! How you summarize will differ based on whether your *independent* variable is qualitative or quantitative:
...
14. Produce a histogram plot (just one, not multiple on the same plot) of the dependent variable. Write 1-2 sentences describing what information you can gather from plot.
...
15. Create a multiple histogram plot of your dependent variable and one other variable (this may or may not be your independent variable).

    Make sure we can see each histogram plot (make sure one isn't blocking another by modifying the transparency and position). Write 1-2 sentences describing what information you can gather from plot.

```{r warning=FALSE}

```

16. Create a box-and-whisker plot which includes your dependent variable. Changing the color of the boxes is optional. Make sure to add points to the plot. Write 1-2 sentences describing what information you can gather from plot.

```{r warning=FALSE}

```

17. Create a scatter plot that includes your dependent variable. Write 1-2 sentences describing what information you can gather from plot.

```{r warning=FALSE}

```

18. Identify which plot(s) from Questions 15-17 match up with your research question. How you know it matches up correctly (based on qualitative vs. quantitative variables)?

*Answer*:

19. In 2-3 sentences, interpret the plot(s) that you identified in the previous question. What does it tell you about your chosen research question?
...
20. Based on everything you know about your independent and dependent variables and the requirements for each of the statistical analyses we covered in the course, determine which statistical analysis you should perform to answer your question. In 1-2 sentence, explain why.

*Answer*:

21. Perform the appropriate statistical analysis below. If necessary, add an additional line of code to print out the results.

```{r}

```

22. If necessary, run a pairwise comparison. If a pairwise comparison is unnecessary for your statistical analysis, explain why.
...
23. Interpret the results of your statistical analysis (including the pairwise comparison, if relevant). In your answer, include the p-value and if the result of your analysis is significant.

*Answer*:

24. What do these results mean in the context of your research question?

*Answer*:

## Expanding Our Horizons

25. Spend some time thinking about the outcome of your research question. Is the outcome what you were expecting or not? Why or why not? What additional information would you like to have to add context to your results? Your answer should be 4-5 sentences.

*Answer:*

26. Think about your research subjects in the context of ecosystem services. What type of ecosystem services might the study of your research question fall under? Explain your rationale.
...
Your abstract should be structured in the following manner, with at least one sentence for each topic (6 sentence minimum):
...
Be sure you include information from your articles for both of your articles from your literature search somewhere in your abstract! Use in-text citations (e.g., Bledsoe et al., 2024) to show where you do so.
