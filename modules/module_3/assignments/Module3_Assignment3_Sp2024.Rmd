...
3.  Create a scatter plot of hair grass density and phosphorus content (do not add a line of best fit yet). Be sure to make the labels easier to understand and add a theme. Also make sure that the dependent variable is on the y-axis.
...
8.  Create the scatter plot that includes the line of best fit. Again, make the labels clearer, add a theme, and make sure the correct variables are on the correct axes.
...
11. Interpret the model summary. What is the p-value for our variable of interest? Do we accept or reject the null hypothesis regarding the relationship between these two variables? What can we conclude, then, about building a road? (2 points)
