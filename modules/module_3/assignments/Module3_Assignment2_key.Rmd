...
5.  In our data set, which variable is the independent variable? Is it categorical or continuous? Which is the dependent variable, and is it categorical or numeric?

    **Independent:** bay, categorical

    **Dependent:** fish_kg, numeric
...
*Answer:* all pairs are significantly different from each other except Sulzberger and Hope
