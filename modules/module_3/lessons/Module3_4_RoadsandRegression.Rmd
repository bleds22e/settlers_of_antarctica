...
Our first order of business is to make sure that we avoid areas with that are well-suited for [Antarctica hair grass](https://oceanwide-expeditions.com/blog/the-plants-of-antarctic) (*Deschamsia antarctica*), one of only two flowering species of plants on the continent. We do not want to damage important habitat for this species.
...
-   Which one is the independent variable and which is the dependent variable?
    -   independent:
    -   dependent:
-   Are the variables categorical or numeric/continuous?
