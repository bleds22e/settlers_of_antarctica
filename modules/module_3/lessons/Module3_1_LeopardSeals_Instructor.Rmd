...
# Number of failed collars by maker
...
# Histogram for battery life of collars
...
# Histogram for battery life of collars, by maker
...
# Add color, labels, and a theme to histogram
ggplot(collars, aes(battery_life, fill = maker)) +
  geom_histogram(alpha = 0.5, position = "identity") +
...
# Relationship between signal distance and battery life
