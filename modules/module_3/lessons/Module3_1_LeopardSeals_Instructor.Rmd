...
The `gg` in `ggplot2` stands for "Grammar of Graphics." The "grammar" part is based on an idea that all statistical plots have the same fundamental features: data and mapping (and specific components of mapping. The design is that you work iteratively, building up layer upon layer until you have your final plot.
