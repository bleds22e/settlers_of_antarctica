...
Before we dive in, if you need a refresher on inferential statistics, check out [this powerpoint](https://docs.google.com/presentation/d/1M23a65rkNsF5e3rMrV2OgIv4WVacMyKa/edit?usp=sharing&ouid=103537286572390245832&rtpof=true&sd=true).
...
How can we determine whether we should *fail to reject* ("accept") or *reject* the null hypothesis? That's where statistics come in.
...
The t-test allows us to determine if the means are likely different due to the random variation or if it represents an actual difference.
...
-   Does that mean we should reject or fail to reject the null hypothesis? REJECT
