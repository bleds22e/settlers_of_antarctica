...
[Here](https://paldhous.github.io/ucb/2016/dataviz/week2.html) is a decent overview of some of the core concepts of data visualization.
...
Reasons: Communication and Interpretation
...
Data Visualization Types: histogram, line graph, pie chart, box-and-whisker plot, phase diagram, heatmap, gradient, river plot, topographic map, bar plots, stacked bar plots, scatter plot, pareto chart, table
...
-   how many and what kind (continuous vs. categorical) variables are in the data description?
-   how many and what kind (continuous vs. categorical) variables are represented in the data visualization? Look at the axes, sizes, colors, etc.
