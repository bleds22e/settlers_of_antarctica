...
The slide deck with more information about descriptive statistics is linked on D2L and [here](https://docs.google.com/presentation/d/1TA3h8t1LoXon0JyvZb9vaQaUWj7Fh7XUYbtIudVZ5T0/edit?usp=sharing).
...
Which variables are we particularly interested in? Are they numeric/continuous or categorical? Does it matter?
...
Scatter plots allow us to visualize the relationship between two continuous (or quantitative) variables. For example, we can use a scatter plot to see if there is a relationship between how old a crew member is and how much fish is in their diet.
