...
2.  Students will be able to generate two types of plots using base R
    ...
    distributions) and two continuous variables (scatterplots).
...
variable...but what we're really interested in is figuring out if fish
or plants are the culprit in food poisoning. Spend 10 minutes in your
groups sketching out a visualization that might give us insight into
this.
